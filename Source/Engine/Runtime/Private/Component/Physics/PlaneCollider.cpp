...
FPlaneCollider::FPlaneCollider()
	: IColliderBase(COMPONENT_TYPE::PLANE_COLLIDER)
	  , bIndependentScale(false)
{
}

FPlaneCollider::FPlaneCollider(const FPlaneCollider& POrigin)
...
FPlaneCollider::~FPlaneCollider() = default;

void FPlaneCollider::FinalTick()
{
	// 크기 * 회전 * 이동
...
void FPlaneCollider::SaveComponent(FILE* InFile)
{
...
void FPlaneCollider::LoadComponent(FILE* InFile)
{
 ...
 */
const AABB FPlaneCollider::GetAABB() const
{

...
void TestSound::Begin()
{
	...
	m_BulletSoundIdx = CSoundMgr::GetInst()->Play3DSound(m_BulletSound, pPos, 1.f, 10000.f, 1, 1.f, false, false, -1);
}

void TestSound::Tick()
{
	Vec3 pPos = Transform()->GetRelativePos();
	m_BulletSoundIdx = CSoundMgr::GetInst()->Play3DSound(m_BulletSound, pPos, 1.f, 10000.f, 1, 1.f, true, false, m_BulletSoundIdx);
}

...
void GunController::Begin()
{
	...
	m_AkdrySound = FAssetManager::GetInst()->Load<FSound>(L"Sound\\gun_dry_reverb.mp3");
	m_ReloadSound = FAssetManager::GetInst()->Load<FSound>(L"Sound\\gun_reload.mp3");
	m_EmptyReloadSound = FAssetManager::GetInst()->Load<FSound>(L"Sound\\gun_empty_reload.mp3");
	m_ClipSound = FAssetManager::GetInst()->Load<FSound>(L"Sound\\gun_clip.mp3");

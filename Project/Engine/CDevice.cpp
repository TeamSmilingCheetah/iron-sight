...
int CDevice::Init(HWND _hWnd, Vec2 _Resolution)
{
    ...
    // RenderTarget, DepthStencilTex, View �����ϱ�
...
int CDevice::CreateBlendState()
{
    ...
    Desc.RenderTarget[0].BlendEnable = true;
    Desc.RenderTarget[0].BlendOp = D3D11_BLEND_OP_ADD; // ���󳢸� ���ϱ�
    Desc.RenderTarget[0].SrcBlend = D3D11_BLEND_ONE; // Source : PixelShader return ���� ���� ���
    Desc.RenderTarget[0].DestBlend = D3D11_BLEND_ONE; // Destination : ������ ��µ� ����Ÿ��
    ...
    Desc.RenderTarget[1].BlendOp = D3D11_BLEND_OP_ADD; // ���󳢸� ���ϱ�
    Desc.RenderTarget[1].SrcBlend = D3D11_BLEND_ONE; // Source : PixelShader return ���� ���� ���
...
int CDevice::CreateDepthStencilState()
{
    ...
    Desc.BackFace.StencilPassOp = D3D11_STENCIL_OP_INCR; // �޸麸�� �տ�(���ʿ�) �ִ�    
    Desc.BackFace.StencilDepthFailOp = D3D11_STENCIL_OP_ZERO; // �޺����� �� �ڿ� �ִ�
    Desc.BackFace.StencilFailOp = D3D11_STENCIL_OP_ZERO; // 

    Desc.FrontFace.StencilFunc = D3D11_COMPARISON_ALWAYS; // �׻����
    Desc.FrontFace.StencilDepthFailOp = D3D11_STENCIL_OP_INCR;
    // �ո麸�� �� �ڿ�(�����޽� ����) �ִ�.        
    Desc.FrontFace.StencilPassOp = D3D11_STENCIL_OP_ZERO; // �ո麸�� �� �տ��ִ�.
